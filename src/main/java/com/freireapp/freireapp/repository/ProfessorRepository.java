...
public class ProfessorRepository {
    ...
    public List<Map<String, Object>> getAlunosPorDisciplina(Long idDisciplina) {
        String sql = "SELECT p.id_pessoa ,p.nome AS nome_aluno, a.fk_Pessoa_id_pessoa AS id_aluno, a.periodo AS periodo_aluno, p.email AS email_aluno, ra.nota AS nota_aluno\n" +
                "FROM Matriculado m\n" +
